...
//    func loadHTML(_ string: String?, baseURL: URL?, withAssetsFile fileName: String?, scrolledToFragment fragment: String?, padding: UIEdgeInsets){
    func loadHTML(_ string: String?, baseURL: URL?, padding: UIEdgeInsets) {
        guard
...
//                DDLogError("window, proxyServer, baseURL or fileName not found");
        ...
        let localFilePath = Bundle.main.path(forResource:"wikipedia", ofType:"html")
        
//        print("あ: " + Bundle.main.path!)
...
//        let templateAndContent = String(format: fileContents, headTagAddition, padding.top as NSNumber, padding.left as NSNumber, padding.right as NSNumber, string ?? "")
        let templateAndContent = String(format: fileContents,
                                        "",
                                        padding.top as NSNumber,
                                        padding.left as NSNumber,
                                        padding.right as NSNumber,
                                        string ?? "")
...
//        loadHTMLFromAssetsFile(requestPath, scrolledToFragment: fragment)
        ...
        loadHTMLString(templateAndContent, baseURL: baseURL)
    ...
    func loadWikipediaPage(_ string: String?, baseURL: URL?, padding: UIEdgeInsets) {
        let html = WikipediaUtility.createWikipediaPage(string!, padding: padding)
